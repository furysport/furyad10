...
furyad10 tx intertx register --from demowallet2 --connection-id connection-0 --chain-id test-2 --home ./data/test-2 --keyring-backend test -y --broadcast-mode=block
...
export DEMOWALLET_2=$(furyad10 keys show -a demowallet2 --home ./data/test-2 --keyring-backend test)
furyad10 query intertx interchainaccounts connection-0 $DEMOWALLET_2
...
# furyad10 q ibc channel channels;
...
# furyad10 query bank balances furya1t7cyvydpp4lklprksnrjy2y3xzv3q2l075vlz3 
