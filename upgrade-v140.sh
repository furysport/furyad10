...
furyad10131 tx gov submit-proposal software-upgrade "v1.4.0" \
--upgrade-height=15 \
--title="Upgrade to v1.4.0" --description="Upgrade to v1.4.0" \
--from=validator --keyring-backend=test \
--chain-id=testing --home=$HOME/.furyad10 --yes -b block --deposit="100000000stake"

furyad10131 tx gov vote 1 yes --from validator --chain-id testing \
--home $HOME/.furyad10 -b block -y --keyring-backend test

furyad10131 query gov proposals

sleep 50

killall furyad10131 &> /dev/null || true

furyad10140 start --home=$HOME/.furyad10

# furyad10140 query ica controller params
# furyad10140 query bank balances $(furyad10140 keys show -a validator --keyring-backend=test)
# furyad10140 tx mint burn-tokens 500000000stake --from validator --chain-id testing --home $HOME/.furyad10 -b block -y --keyring-backend test
...
# furyad10140 query bank balances furya17dtl0mjt3t77kpuhg2edqzjpszulwhgzn87f8z
# icad query bank balances cosmos1mjk79fjjgpplak5wq838w0yd982gzkyfrk07am --node http://localhost:16657


furyad10140 tx bank send validator furya17dtl0mjt3t77kpuhg2edqzjpszulwhgzn87f8z 10000000stake --chain-id testing \
--home $HOME/.furyad10 -b block -y --keyring-backend test
...
furyad10140 tx intertx register --connection-id=connection-0 --from validator --chain-id testing \
--home $HOME/.furyad10 -b block -y --keyring-backend test

export VALIDATOR=$(furyad10 keys show -a validator --home $HOME/.furyad10 --keyring-backend test)
furyad10 query intertx interchainaccounts connection-0 $VALIDATOR
