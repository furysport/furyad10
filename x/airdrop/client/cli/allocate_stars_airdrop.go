...
Example:
	furyad10 tx airdrop allocate-stars-airdrop Airdrop_HuahuaPunks_Feuille_1.csv 0 500 --from=validator --keyring-backend=test --chain-id=testing --home=$HOME/.furyad10/ --yes --broadcast-mode=block --gas=10000000
`,
